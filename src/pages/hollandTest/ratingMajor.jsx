...
const RatingMajor = ({ studentId }) => {
  ...
  const fetchMajorDescription = async (majorId) => {
    try {
      const response = await getMajorById(majorId, studentId);
            ...
            >
              ...
              >
                <Text style={{ textAlign: "center" }}>
                  Việc đánh giá dựa theo sở thich về các ngành học phù hợp với
                  bạn để hệ thống chúng tôi gợi ý các nghề nghiệp tương lai
                </Text>
                <Box
                  style={{
                    display: "flex",
                  ...
                  >
                    {ratingMajors.map((major, index) => (
                      <div
                        ...
                        style={{
                          display:
                            index === currentCardIndex ? "block" : "none",
                        }}
                      >
                        <RatingCard
                          major={major}
